        ...
        <div
            className={"relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden max-w-lg w-full"}>
                ...
                {!hideHeader && (
                    ...
                    <button
                        type="button"
                        className="text-gray-400 bg-400 bg-transparent hover:bg-gray-200 hover:text-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5"
                        onClick={onClose}>
                            <svg
                                className="w-3 h-3"
                                aria-hidden="true"

...
export const DUMMY_RESUME_DATA ={
    profileInfo: {
        ...
        summary:
        "Passionate and results-driven developer with 6+ years of experience",
    },
    contactInfo: {
    ...
    workExperience: [
        {
            ...
            startDate: "2022-03",
            endDate: "2025-04",
            description: "Leading the frontend team to build scalable enterprise applications",
        },
        {
            company: "Coding Dev",
            ...
            startDate: "2020-01",
            endDate: "2022-02",
            description: "Worked on cross-functional teams developing full-stack solutions",
        },
        {
            ...
            startDate: "2018-06",
            endDate: "2019-12",
            description: "Built responsive websites for startups and small businesses",
        },
    ],
    education: [
        {
